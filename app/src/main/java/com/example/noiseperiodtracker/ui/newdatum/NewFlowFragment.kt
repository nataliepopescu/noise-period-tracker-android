...
import com.example.noiseperiodtracker.databinding.FragmentNewFlowBinding

class NewFlowFragment : Fragment() {

    private var _binding: FragmentNewFlowBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentNewFlowBinding.inflate(inflater, container, false)
        return binding.root
    }
